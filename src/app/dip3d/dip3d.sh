...
I_dip_path=/data1/chenying/dip3d-1/Falign
...
I_clair3_model_directory=/data1/chenying/dip3d-1/dip3d/clair3_porec_model
...
function map_pore_c_reads_with_falign()
{
	...
	local opts="-num_threads ${I_threads} -outfmt frag-bam -out ${bam}"
	if [ -n "${I_enzyme}" ]; then
